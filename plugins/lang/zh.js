...
export default {
  ...
  core: {
    ...
    regcode:
      "为加强站内人员管理，站点开启了人工验证注册用户，请耐心等待审核通过。",
    bind_error: "绑定错误",
    noAvatar: "无",
    thousand: "万",
    content: "内容",
  ...
  post: {
    ...
    voteOption: '选项 :',
    addOption: '+添加选项',
    optionSelect: '请填写投票选项',
    atMost: '最多可选:',
    countingDays: '记票天数:',
    voteResult: '投票结果可见:',
    participants: '公开投票参与人:',
    votingOptionsBeLessThan2: '投票选项不能小于2',
    maximumSelectRange: '最多可选项必须大于0，且不能超过投票选项数量',
    countingDaysBeGreaterThan0: '计票天数必须大于0',
    pleaseEnterAnInteger: '请输入大于0的整数',
  },
  topic: {
    to: "向",
    ask: "提问",
  ...
  pay: {
    ...
    cashtext:
      "需确保在微信开启了“允许通过手机号向我转账”的功能，否则将无法收到提现转账，开通方式为“微信-收付款-向银行卡或手机号转账-手机号收款设置“。",
    surePay: "确认支付",
    scanPay: "扫码支付",
    paySuccess: "支付成功",
    payFail: "支付失败",
  ...
  profile: {
    ...
    filedownloadtipswx:
      "因系统限制，无法下载文件。请使用安卓手机或电脑访问H5版进行下载"
  },
  site: {
